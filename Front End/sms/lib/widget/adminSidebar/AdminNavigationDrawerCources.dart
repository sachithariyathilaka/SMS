...
class AdminNavigationDrawerCources extends StatefulWidget {
  @override
  AdminNavigationDrawerCourcesState createState() {
    return new AdminNavigationDrawerCourcesState();
  }
}

class AdminNavigationDrawerCourcesState extends State<AdminNavigationDrawerCources> with SingleTickerProviderStateMixin{
