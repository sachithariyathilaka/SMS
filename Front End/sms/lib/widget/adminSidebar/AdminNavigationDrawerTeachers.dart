...
class AdminNavigationDrawerTeachers extends StatefulWidget {
  @override
  AdminNavigationDrawerStateTeachers createState() {
    return new AdminNavigationDrawerStateTeachers();
  }
}

class AdminNavigationDrawerStateTeachers extends State<AdminNavigationDrawerTeachers> with SingleTickerProviderStateMixin{
  double maxWidth = 220.0;
  double minWidth = 70.0;
  bool isCollapsed = true;
  AnimationController animationController;
  Animation<double> widthAnimation;
  int curruntSelectedIndex = 1;
