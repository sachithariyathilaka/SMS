...
class AdminNavigationDrawerSettings extends StatefulWidget {
  @override
  AdminNavigationDrawerSettingsState createState() {
    return new AdminNavigationDrawerSettingsState();
  }
}

class AdminNavigationDrawerSettingsState extends State<AdminNavigationDrawerSettings> with SingleTickerProviderStateMixin{
  double maxWidth = 220.0;
  double minWidth = 70.0;
  bool isCollapsed = true;
  AnimationController animationController;
  Animation<double> widthAnimation;
  int curruntSelectedIndex = 5;
              ...
              itemBuilder: (context, counter){
                return CollapsingListTile(
                    onTap: (){
                      ...
                      }else if(adminNavigationItems[counter].title == 'Settings'){
                        Navigator.push(
                          context,
