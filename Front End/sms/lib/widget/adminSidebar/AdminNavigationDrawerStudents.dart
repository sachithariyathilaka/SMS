...
class AdminNavigationDrawerStudents extends StatefulWidget {
  @override
  AdminNavigationDrawerStateStudents createState() {
    return new AdminNavigationDrawerStateStudents();
  }
}

class AdminNavigationDrawerStateStudents extends State<AdminNavigationDrawerStudents> with SingleTickerProviderStateMixin{
