...
class AdminNavigationDrawer extends StatefulWidget {
  @override
  AdminNavigationDrawerState createState() {
    return new AdminNavigationDrawerState();
  }
}

class AdminNavigationDrawerState extends State<AdminNavigationDrawer> with SingleTickerProviderStateMixin{
