...
class StudentNavigationDrawerCourse extends StatefulWidget {
  @override
  StudentNavigationDrawerCourseState createState() {
    return new StudentNavigationDrawerCourseState();
  }
}

class StudentNavigationDrawerCourseState extends State<StudentNavigationDrawerCourse> with SingleTickerProviderStateMixin{
