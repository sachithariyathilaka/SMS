...
class StudentNavigationDrawerAttendance extends StatefulWidget {
  @override
  StudentNavigationDrawerAttendanceState createState() {
    return new StudentNavigationDrawerAttendanceState();
  }
}

class StudentNavigationDrawerAttendanceState extends State<StudentNavigationDrawerAttendance> with SingleTickerProviderStateMixin{
