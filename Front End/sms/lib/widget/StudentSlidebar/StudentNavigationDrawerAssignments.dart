...
import 'package:sms/pages/Student/CourseView.dart';
...
class StudentNavigationDrawerAssignments extends StatefulWidget {
  @override
  StudentNavigationDrawerAssignmentsState createState() {
    return new StudentNavigationDrawerAssignmentsState();
  }
}

class StudentNavigationDrawerAssignmentsState extends State<StudentNavigationDrawerAssignments> with SingleTickerProviderStateMixin{
  double maxWidth = 220.0;
  double minWidth = 70.0;
  bool isCollapsed = true;
  AnimationController animationController;
  Animation<double> widthAnimation;
  int curruntSelectedIndex = 3;
