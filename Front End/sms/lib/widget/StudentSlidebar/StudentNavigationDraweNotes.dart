...
class StudentNavigationDrawerNotes extends StatefulWidget {
  @override
  StudentNavigationDrawerNotesState createState() {
    return new StudentNavigationDrawerNotesState();
  }
}

class StudentNavigationDrawerNotesState extends State<StudentNavigationDrawerNotes> with SingleTickerProviderStateMixin{
