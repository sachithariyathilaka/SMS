...
class StudentViewCourse extends StatefulWidget {
  ...
  @override
  StudentViewCourseState createState() => StudentViewCourseState();
}

class StudentViewCourseState extends State<StudentViewCourse> with SingleTickerProviderStateMixin{
