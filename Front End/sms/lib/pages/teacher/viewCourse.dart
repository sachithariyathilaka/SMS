...
import 'package:sms/pages/teacher/studentInCourse.dart';
...
class TeacherViewCourse extends StatefulWidget {
  ...
  @override
  TeacherViewCourseState createState() => TeacherViewCourseState();
}

class TeacherViewCourseState extends State<TeacherViewCourse> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              icon: Icon(Icons.person, color: Colors.white, size: 35.0,),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => new StudentInCourseTeacher()),
                );
              },
            )
          ],
