...
class CoursesForNotes extends StatefulWidget {

  @override
  CoursesForNotesState createState() => CoursesForNotesState();
}

class CoursesForNotesState extends State<CoursesForNotes> with SingleTickerProviderStateMixin{
