...
class viewStudentForCourseTeacher extends StatefulWidget {

  @override
  viewStudentForCourseTeacherState createState() => viewStudentForCourseTeacherState();
}

class viewStudentForCourseTeacherState extends State<viewStudentForCourseTeacher> with SingleTickerProviderStateMixin{
