...
class NewAssignments extends StatefulWidget {
  ...
  @override
  NewAssignmentsState createState() => NewAssignmentsState();
}

class NewAssignmentsState extends State<NewAssignments> with SingleTickerProviderStateMixin{
                                ...
                                Container(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: 'Enter Assignment Link',
                                      hintStyle: kHintTextStyle,
                                    ),
                                  ),
                                )
    ...
    if(response.statusCode == 200){
      setState(() {
        ...
        Fluttertoast.showToast(
            msg: "Assignment Insert Succusfully!!",
