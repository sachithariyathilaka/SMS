...
import 'package:sms/pages/teacher/assignments.dart';
import 'package:sms/widget/ListTile.dart';
import 'package:sms/widget/teacherSidebar/TeacherNavigationDrawerAssignments.dart';



class CoursesForAssignment extends StatefulWidget {

  @override
  CoursesForAssignmentState createState() => CoursesForAssignmentState();
}

class CoursesForAssignmentState extends State<CoursesForAssignment> with SingleTickerProviderStateMixin{
    ...
    return Scaffold(
        ...
        body: Stack(
          children: <Widget>[
                    ...
                    itemBuilder: (context, counter){
                      return listTile(
                        onTap: (){
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => new Assignments()),
                          );
                        },
            ...
            TeacherNavigationDrawerAssignments()
          ],
        )
    );
  }
