...
import 'package:sms/pages/teacher/newDates.dart';
import 'package:sms/pages/teacher/viewAttendance.dart';
...
class ViewDatesState extends State<ViewDates> with SingleTickerProviderStateMixin{
          ...
          actions: <Widget>[
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => new NewDates()),
                );
              },
            )
          ],
                    ...
                    itemBuilder: (context, counter){
                      return listTile(
                        onTap: (){
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => new ViewAttendance()),
                          );
                        },
                        title: dates[counter],
  ...
  void getDatesForCourse() async{
    ...
    var response = await http.post("http://13.212.36.183:8081/getAttendanceDatesForCourse", body: data, headers: headers);
    var jsonData = null;
