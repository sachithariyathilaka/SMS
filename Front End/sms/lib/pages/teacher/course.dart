...
class TeacherCourseView extends StatefulWidget {
  ...
  @override
  TeacherCourseViewState createState() => TeacherCourseViewState();
}

class TeacherCourseViewState extends State<TeacherCourseView> with SingleTickerProviderStateMixin{
                    ...
                    itemBuilder: (context, counter){
                      return listTile(
                        onTap: (){
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => new TeacherViewCourse()),
                          );
                        },
