...
import 'package:sms/pages/teacher/viewStudentForCourse.dart';
import 'package:sms/widget/ListTile.dart';
import 'package:sms/widget/teacherSidebar/TeacherNavigationDrawerCourse.dart';


class StudentInCourseTeacher extends StatefulWidget {

  @override
  StudentInCourseTeacherState createState() => StudentInCourseTeacherState();
}

class StudentInCourseTeacherState extends State<StudentInCourseTeacher> with SingleTickerProviderStateMixin{
                    ...
                    itemBuilder: (context, counter){
                      return listTile(
                        onTap: (){
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => new viewStudentForCourseTeacher()),
                          );
                        },
