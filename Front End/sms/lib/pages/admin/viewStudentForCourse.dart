...
class viewStudentForCourse extends StatefulWidget {

  @override
  viewStudentForCourseState createState() => viewStudentForCourseState();
}

class viewStudentForCourseState extends State<viewStudentForCourse> with SingleTickerProviderStateMixin{
