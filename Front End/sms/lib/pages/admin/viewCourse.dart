...
import 'package:sms/pages/admin/studentInCourse.dart';
...
class viewCourseState extends State<viewCourse> with SingleTickerProviderStateMixin{
          ...
          actions: <Widget>[
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => new StudentInCourse()),
                );
              },
            )
          ],
