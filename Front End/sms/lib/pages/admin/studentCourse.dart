...
import 'package:sms/pages/admin/viewCourseForStudent.dart';
...
class StudentCourseState extends State<StudentCourse> with SingleTickerProviderStateMixin {
                        ...
                        onTap: () {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(builder: (
                                context) => new viewCourseForStudent()),
                          );
                        },
  ...
  void getAllCourses() async {
    ...
    var response = await http.post(
        "http://13.212.36.183:8081/getCoursesByStudent", body: data,
        headers: headers);
    var jsonData = null;
