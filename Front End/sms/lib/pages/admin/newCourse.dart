...
class NewCourseState extends State<NewCourse> with SingleTickerProviderStateMixin{
  ...
  List<String> locations = ['Yakkala', 'Kiribathgoda', 'Kadawatha', 'Waththala'];
                                          ...
                                          child: Container(
                                            ...
                                            child: DropdownButtonHideUnderline(
                                              child: DropdownButton<String>(
                                                ...
                                                iconSize: 24,
                                                iconEnabledColor: Colors.white,
                                                hint: Text('Select Teacher', style: TextStyle(color: Colors.white)),
                                                style: TextStyle(color: Colors.white),
                                                onChanged: (String newValue) {
                                                  setState(() {
                                ...
                                child: Container(
                                  ...
                                  child: RaisedButton(
                                    ...
                                    onPressed: (){
                                      ...
                                      registerCourse(fullNameBox.text, startDate.text, hall.text, time.text, duration.text, locationValue, teacherValue);
                                    },
  ...
  registerCourse(String name, String startDate, String hall, String time, String duration, String location, String teacher) async {
    Map data = {
      "courseName": name,
      "hall": hall,
      "startDate": startDate,
    ...
    var response = await http.post("http://13.212.36.183:8081/registerCourse", body: jsonEncode(data), headers: headers);
    if(response.statusCode == 200){
      setState(() {
        isLoading=false;
        Fluttertoast.showToast(
            msg: "Course Registered Succusfully!!",
